...
def staff_home(request):
    ...
    return render(request, "cms/staff_template/staff_home_template.html", context)
...
def staff_take_attendance(request):
    ...
    return render(request, "cms/staff_template/take_attendance_template.html", context)
...
def staff_apply_leave(request):
    ...
    return render(request, "cms/staff_template/staff_apply_leave_template.html", context)


def staff_apply_leave_save(request):
    if request.method != "POST":
        messages.error(request, "Invalid Method")
        return redirect('cms:staff_apply_leave')
    else:
...
def staff_feedback(request):
    ...
    # }
    return render(request, "cms/staff_template/staff_feedback_template.html")


def staff_feedback_save(request):
    if request.method != "POST":
        messages.error(request, "Invalid Method.")
        return redirect('cms:staff_feedback')
    else:
...
def staff_update_attendance(request):
    ...
    return render(request, "cms/staff_template/update_attendance_template.html", context)
...
def staff_profile(request):
    ...
    return render(request, 'cms/staff_template/staff_profile.html', context)


def staff_profile_update(request):
    if request.method != "POST":
        messages.error(request, "Invalid Method!")
        return redirect('cms:staff_profile')
    else:
...
def staff_add_result(request):
    ...
    return render(request, "cms/staff_template/add_result_template.html", context)


def staff_add_result_save(request):
    if request.method != "POST":
        messages.error(request, "Invalid Method")
        return redirect('cms:staff_add_result')
    else:
