...
class Group(AuthGroup):
    # Custom fields for your Group model
    pass

class Permission(AuthPermission):
    # Custom fields for your Permission model
    pass
...
class CustomUser(AbstractUser):
    ...
    EMAIL_TO_USER_TYPE_MAP = {
        ...
        # Specify a different related_query_name for the groups field
   ...
   # Specify a different related_name for the user_permissions field in CustomUser model
    user_permissions = models.ManyToManyField(
        Permission,
        verbose_name='custom user permissions',
        blank=True,
        related_name='custom_custom_users'
    )
