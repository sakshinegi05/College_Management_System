...
urlpatterns = [
    ...
    path('doRegistration/', views.doRegistration, name="doRegistration"),
      ...
      # URLS for Student
    path('doLogin/student_home/', StudentViews.student_home, name="student_home"),
    ...
    path('student_view_result/', StudentViews.student_view_result, name="student_view_result"),
     ...
     # URLS for Staff
    path('doLogin/staff_home/', StaffViews.staff_home, name="staff_home"),
    ...
    # URL for Admin
    path('doLogin/admin_home/', HodViews.admin_home, name="admin_home"),
